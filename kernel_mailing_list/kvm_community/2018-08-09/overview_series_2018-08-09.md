#### [PATCH 1/2] kvm: expose KVM_CAP_ENABLE_CAP in KVM_CHECK_EXTENSIONFrom: Peter Shier <pshier@google.com>
...
```
#### [PATCH] kvm: mmu: Don't read PDPTEs when paging is not enabledFrom: Junaid Shahid <junaids@google.com>
...
```
#### [patch 1/2] KVM: x86: switch KVMCLOCK base to CLOCK_MONOTONIC_RAWReferences: <20180809144302.933793954@amt.cnet>
...
+		kvm_gen_update_masterclock(kvm);
 	...
 	case KVM_GET_CLOCK: {
```
#### [patch 1/2] KVM: x86: switch KVMCLOCK base to CLOCK_MONOTONIC_RAWReferences: <20180809145245.722399627@amt.cnet>
##### From: Marcelo Tosatti <mtosatti@redhat.com>
