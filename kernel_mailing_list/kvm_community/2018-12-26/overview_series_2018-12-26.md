...
```
#### [PATCH] kvm, x86: simplify manipulation of ASYNC_PF_PER_VCPU on x86
...
```
#### [RFC][PATCH v2 01/21] e820: cheat PMEM as DRAMReferences: <20181226131446.330864849@intel.com>
