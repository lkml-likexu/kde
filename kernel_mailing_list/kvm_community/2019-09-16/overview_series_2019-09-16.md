...
X-Patchwork-Id: 11147837
Return-Path: <SRS0=87xZ=XL=vger.kernel.org=kvm-owner@kernel.org>
Received: from mail.kernel.org (pdx-korg-mail-1.web.codeaurora.org
 [172.30.200.123])
	by pdx-korg-patchwork-2.web.codeaurora.org (Postfix) with ESMTP id B252114ED
	for <patchwork-kvm@patchwork.kernel.org>;
 Mon, 16 Sep 2019 20:48:10 +0000 (UTC)
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.kernel.org (Postfix) with ESMTP id 909CC214AF
	for <patchwork-kvm@patchwork.kernel.org>;
 Mon, 16 Sep 2019 20:48:10 +0000 (UTC)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2388457AbfIPUrb (ORCPT
...
X-Google-Smtp-Source: 
 APXvYqxISkd0F2RDS0tk8mctmfGj06rkked0k46A5N+m1h5H/Qt5p0hKECOmJeL+5l43LAR/maBo9Q==
...
Received: from black.home (broadband-188-32-48-208.ip.moscow.rt.ru.
 ...
 x6sm231437wmf.38.2019.09.16.13.47.26
...
X-Patchwork-Id: 11147615
Return-Path: <SRS0=87xZ=XL=vger.kernel.org=kvm-owner@kernel.org>
Received: from mail.kernel.org (pdx-korg-mail-1.web.codeaurora.org
 [172.30.200.123])
	by pdx-korg-patchwork-2.web.codeaurora.org (Postfix) with ESMTP id 3587D1708
	for <patchwork-kvm@patchwork.kernel.org>;
 Mon, 16 Sep 2019 16:55:01 +0000 (UTC)
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.kernel.org (Postfix) with ESMTP id D591D21881
	for <patchwork-kvm@patchwork.kernel.org>;
 Mon, 16 Sep 2019 16:55:00 +0000 (UTC)
Authentication-Results: mail.kernel.org;
	dkim=fail reason="signature verification failed" (2048-bit key)
 header.d=gmail.com header.i=@gmail.com header.b="J+ta2NJA"
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1729498AbfIPQy4 (ORCPT
        <rfc822;patchwork-kvm@patchwork.kernel.org>);
        Mon, 16 Sep 2019 12:54:56 -0400
Received: from mail-wm1-f65.google.com ([209.85.128.65]:37428 "EHLO
        mail-wm1-f65.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1729089AbfIPQy4 (ORCPT <rfc822;kvm@vger.kernel.org>);
        Mon, 16 Sep 2019 12:54:56 -0400
Received: by mail-wm1-f65.google.com with SMTP id r195so118423wme.2;
        Mon, 16 Sep 2019 09:54:45 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20161025;
        h=sender:from:to:cc:subject:date:message-id:mime-version
         :content-transfer-encoding;
        bh=CEgy+yox7BnYc16JSBSYFqqGTnmoyEA/aV6ue6wTkCw=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20161025;
        ...
        bh=CEgy+yox7BnYc16JSBSYFqqGTnmoyEA/aV6ue6wTkCw=;
        b=
X-Gm-Message-State: APjAAAVAGjvUmCY/cNYAkvcpeLKF6teXGmbQi7EL42bnNmDRIhSZVhhQ
        gcfUvoRRT6IQFNRBY2TRxH0=
X-Google-Smtp-Source: 
 APXvYqzIIPA6DFldz/N3Ga4xMW0s1JkqkBbEdfKpYPp7cFPIRUWZGrSv5CdOxqpwXskKZYuUjaw54A==
X-Received: by 2002:a7b:c949:: with SMTP id i9mr107121wml.136.1568652883254;
        Mon, 16 Sep 2019 09:54:43 -0700 (PDT)
Received: from 640k.lan ([93.56.166.5])
        by smtp.gmail.com with ESMTPSA id
 h7sm11134007wrt.17.2019.09.16.09.54.41
        (version=TLS1_2 cipher=ECDHE-RSA-AES128-GCM-SHA256 bits=128/128);
        Mon, 16 Sep 2019 09:54:42 -0700 (PDT)
From: Paolo Bonzini <pbonzini@redhat.com>
To: torvalds@linux-foundation.org
Cc: linux-kernel@vger.kernel.org, rkrcmar@redhat.com,
        kvm@vger.kernel.org
Subject: [GIT PULL] First batch of KVM changes for Linux 5.4
Date: Mon, 16 Sep 2019 18:54:41 +0200
Message-Id: <1568652881-21933-1-git-send-email-pbonzini@redhat.com>
...
X-Patchwork-Id: 11146505
Return-Path: <SRS0=87xZ=XL=vger.kernel.org=kvm-owner@kernel.org>
Received: from mail.kernel.org (pdx-korg-mail-1.web.codeaurora.org
 [172.30.200.123])
	by pdx-korg-patchwork-2.web.codeaurora.org (Postfix) with ESMTP id 114A11745
	for <patchwork-kvm@patchwork.kernel.org>;
 Mon, 16 Sep 2019 07:13:00 +0000 (UTC)
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.kernel.org (Postfix) with ESMTP id E348120890
	for <patchwork-kvm@patchwork.kernel.org>;
 Mon, 16 Sep 2019 07:12:59 +0000 (UTC)
Authentication-Results: mail.kernel.org;
	dkim=pass (2048-bit key) header.d=gmail.com header.i=@gmail.com
 header.b="khSq9uAQ"
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1729172AbfIPHMz (ORCPT
        <rfc822;patchwork-kvm@patchwork.kernel.org>);
...
Content-Transfer-Encoding: 8bit
X-Patchwork-Submitter: Wanpeng Li <kernellwp@gmail.com>
X-Patchwork-Id: 11146537
Return-Path: <SRS0=87xZ=XL=vger.kernel.org=kvm-owner@kernel.org>
Received: from mail.kernel.org (pdx-korg-mail-1.web.codeaurora.org
 [172.30.200.123])
	by pdx-korg-patchwork-2.web.codeaurora.org (Postfix) with ESMTP id 55E4B1747
	for <patchwork-kvm@patchwork.kernel.org>;
 Mon, 16 Sep 2019 07:42:42 +0000 (UTC)
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.kernel.org (Postfix) with ESMTP id 34326206C2
	for <patchwork-kvm@patchwork.kernel.org>;
 Mon, 16 Sep 2019 07:42:42 +0000 (UTC)
Authentication-Results: mail.kernel.org;
	dkim=pass (2048-bit key) header.d=gmail.com header.i=@gmail.com
...
X-Google-Smtp-Source: 
 APXvYqz6UXb+1m2RY5wgCOKMbqJoz8UuUxUz1PwKGU2byU6AGn21tsVQ4b9kP+cucwWs52QAxFK4wg==
X-Received: by 2002:a63:ef4d:: with SMTP id
 c13mr17809326pgk.200.1568619757028;
        Mon, 16 Sep 2019 00:42:37 -0700 (PDT)
Received: from localhost.localdomain ([203.205.141.123])
        by smtp.googlemail.com with ESMTPSA id
 s19sm36531063pfe.86.2019.09.16.00.42.34
        (version=TLS1_2 cipher=ECDHE-RSA-AES128-SHA bits=128/128);
...
Cc: Paolo Bonzini <pbonzini@redhat.com>,
 ...
 Vitaly Kuznetsov <vkuznets@redhat.com>, Wanpeng Li <wanpengli@tencent.com>,
 Jim Mattson <jmattson@google.com>, Joerg Roedel <joro@8bytes.org>
Subject: [PATCH v3] KVM: hyperv: Fix Direct Synthetic timers assert an
...
Content-Transfer-Encoding: 7bit
X-Patchwork-Submitter: Wanpeng Li <kernellwp@gmail.com>
X-Patchwork-Id: 11146579
Return-Path: <SRS0=87xZ=XL=vger.kernel.org=kvm-owner@kernel.org>
Received: from mail.kernel.org (pdx-korg-mail-1.web.codeaurora.org
 [172.30.200.123])
	by pdx-korg-patchwork-2.web.codeaurora.org (Postfix) with ESMTP id 3858F14ED
	for <patchwork-kvm@patchwork.kernel.org>;
 Mon, 16 Sep 2019 08:40:10 +0000 (UTC)
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.kernel.org (Postfix) with ESMTP id 0C295214AF
	for <patchwork-kvm@patchwork.kernel.org>;
 Mon, 16 Sep 2019 08:40:10 +0000 (UTC)
Authentication-Results: mail.kernel.org;
	dkim=pass (2048-bit key) header.d=gmail.com header.i=@gmail.com
...
X-Google-Smtp-Source: 
 APXvYqwu5cITqeiAEi4QFL9pRpNDpoDeJfXYSOvd9YwqHTvOD69wHbpDN7UWVLcnsyMqq7KXJJq/jw==
X-Received: by 2002:a17:902:b40c:: with SMTP id
 x12mr63973886plr.145.1568623204869;
        Mon, 16 Sep 2019 01:40:04 -0700 (PDT)
Received: from localhost.localdomain ([203.205.141.123])
        by smtp.googlemail.com with ESMTPSA id
 l124sm32781547pgl.54.2019.09.16.01.40.02
        (version=TLS1_2 cipher=ECDHE-RSA-AES128-SHA bits=128/128);
        Mon, 16 Sep 2019 01:40:04 -0700 (PDT)
From: Wanpeng Li <kernellwp@gmail.com>
X-Google-Original-From: Wanpeng Li <wanpengli@tencent.com>
